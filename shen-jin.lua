elseif game.PlaceId == 12931609417 then
    YIJIAOBEN = "YIJIAOBEN"
loadstring(game:HttpGet("https://github.com/shenjin55/qq-927274889/raw/refs/heads/main/sss.lua"))()
...
local about = UITab1:section("『神金脚本』",false)
...
about:Button("脚本不想持续更新中")
about:Button("脚本懒得优化")
about:Button("欢迎使用")

local UITab4 = win:Tab("『加入服务器』",'16060333448')

local about = UITab4:section("『神金脚本』",true)
...
local about = UITab6:section("『普通』",true)
...
about:Button("传送到玩家旁边", function()
    ...
    if tp_player and tp_player.Character and tp_player.Character.HumanoidRootPart then
        ...
        Notify("神金", "已经传送到玩家身边", "rbxassetid://", 5)
    else
        Notify("神金", "无法传送 玩家已消失", "rbxassetid://", 5)
    end
end)
...
about:Toggle("查看玩家", 'Toggleflag', false, function(state)
    if state then
        game:GetService('Workspace').CurrentCamera.CameraSubject =
            ...
            Notify("神金", "已开启", "rbxassetid://", 5)
    else
        Notify("神金", "已关闭", "rbxassetid://", 5)
...
about:Toggle("脚本框架小一点", "", false, function(state)
        if state then
...
local about = UITab6:section("『其他』",true)
...
local UITab11 = win:Tab("『其他脚本』",'16060333448')

local about = UITab11:section("『其他脚本』",true)
...
local about = UITab20:section("『神金脚本』",true)
...
local UITab26 = win:Tab("『俄亥俄州』",'16060333448')

local about = UITab26:section("『俄亥俄州』",true)

about:Button("自动捡印钞机",function()
loadstring(game:HttpGet("https://pastebin.com/raw/3VpWVZtC"))() 
end)

about:Button("自动工作和自动传送地点",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/LOLking123456/ohio/main/Roblox232"))()
end)

about:Button("自动印钞机和换服",function()
...
local UITab26 = win:Tab("『BF』",'16060333448')
...
local UITab26 = win:Tab("『内脏与黑火焰』",'16060333448')
...
local UITab26 = win:Tab("『铲雪模拟器』",'16060333448')
...
local about = UITab26:section("『功能』",true)
   ...
   local UITab26 = win:Tab("『监狱人生』",'16060333448')
...
local UITab26 = win:Tab("『造船寻宝』",'16060333448')
...
about:Button("变鸡",function()
   ...
   local UITab26 = win:Tab("『doors』",'16060333448')
...
about:Button("没有惊吓",function()
        pcall(function()
            game:GetService("ReplicatedStorage").Bricks.Jumpscare:Destroy()
        end)
          end)
          
about:Button("完整的断路器盒小游戏",function()
        game:GetService("ReplicatedStorage").Bricks.EBF:FireServer()
          end)
about:Button("跳过门50",function()
...
local UITab26 = win:Tab("『力量传奇』",'16060333448')
...
local UITab1 = win:Tab("颜色或者死亡",'16060333448')

local about = UITab1:section("『颜色或死亡』",true)

about:Button("你不在这个服务器里")
about:Button("请加入这个服务器后再尝试")